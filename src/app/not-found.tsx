  ...
  return (
    <Box sx={{
      ...
      <Box sx={{
        ...
        bottom: 0,
        opacity: 0.1,
        background: 'radial-gradient(circle at 20% 50%, #0279F2 0%, transparent 50%), radial-gradient(circle at 80% 80%, #014B99 0%, transparent 50%)',
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <svg 
              ...
              style={{
                filter: 'drop-shadow(0 10px 30px rgba(2, 121, 242, 0.3))'
              }}
            >
          ...
          <Box sx={{
            ...
            <Button
              ...
              sx={{
                ...
                borderColor: 'rgba(2, 121, 242, 0.5)',
                borderWidth: '2px',
                px: 4,
                py: 1.5,
                fontSize: '1rem',
            ...
            <Button
              ...
              startIcon={<LayoutDashboard className="w-5 h-5" />}
              sx={{
                color: 'rgba(255,255,255,0.9)',
                borderColor: 'rgba(2, 121, 242, 0.5)',
                borderWidth: '2px',
